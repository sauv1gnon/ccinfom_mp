...
(1,'The','Damselette','+1-555-0002','columbina@patient.test',SHA2('s4ndr0neWasHere',256),NOW(),NOW());
...
(1,'House','Gregory','greg.house@doctor.test',SHA2('HousePass123',256),JSON_ARRAY(1),'available',JSON_ARRAY(
...
(2,'columbina@patient.test',SHA2('s4ndr0neWasHere',256),'PATIENT',1,1,NOW(),NOW()),
(3,'greg.house@doctor.test',SHA2('HousePass123',256),'DOCTOR',1,1,NOW(),NOW());
